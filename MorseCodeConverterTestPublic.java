...
public class MorseCodeConverterTestPublic {
	...
	public void testConvertMorseStringToEnglishString() {	
		...
		//Student Test
		String STUDENTconverter = MorseCodeConverter.convertToEnglish(". - -- -.-- / -... .- .-. -... --- ... .-");
		assertEquals("etmy barbosa", STUDENTconverter);
	...
	public void testConvertMorseFileToEnglishString() {	
		...
		*/
		...
		//Student Test
		File STUDENTfile = new File("src/LoveLooksNot.txt"); 
		try {
			assertEquals("love looks not with the eyes but with the mind", MorseCodeConverter.convertToEnglish(STUDENTfile));
		} catch (FileNotFoundException e) {
			assertTrue("An unwanted exception was caught", false);
		}
	}
